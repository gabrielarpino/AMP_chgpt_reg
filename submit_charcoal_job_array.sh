...
#SBATCH -J charcoal_L2_sigma0_2_fixed_snr_uniform_pl_sigmaw20
#SBATCH --nodes=1
...
#SBATCH -o hpc_results/charcoal_L2_sigma0_2_fixed_snr_uniform_pl_sigmaw20_%A_%a.out
#SBATCH -e hpc_results/charcoal_L2_sigma0_2_fixed_snr_uniform_pl_sigmaw20_%A_%a.err
...
options="hpc_comparison_sparse_diff.py --save_path "$save_path" \
    ...
    --p 300  --sigma_w 20 --sigma 0.2 \
    --L 2 --Lmax 3 --num_trials 10 --frac_Delta 0.03 "
# options="hpc_comparison_sparse_diff.py --save_path "$save_path" \
